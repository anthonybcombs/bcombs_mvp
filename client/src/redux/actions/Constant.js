...
export const REQUEST_UPDATE_VENDOR_COMPLETED = "REQUEST_UPDATE_VENDOR_COMPLETED";

//APPLICATION
export const REQUEST_ADD_APPLICATION = "REQUEST_ADD_APPLICATION";
export const REQUEST_ADD_APPLICATION_COMPLETED = "REQUEST_ADD_APPLICATION_COMPLETED";
