//auth
export const REQUEST_AUTH_REMOVE_MESSAGES = "REQUEST_AUTH_REMOVE_MESSAGES";
export const REQUEST_AUTH_REMOVE_MESSAGES_COMPLETED =
  "REQUEST_AUTH_REMOVE_MESSAGES_COMPLETED";
