...
export const initialState = {./actions/Constant
  auth: {
    status: "ANONYMOUS"
  },
  events: [
    {
      id: uuid(),
      na./actions/Authent 1",
      description:./actions/Calendars
        "Elit ad nisi veniam qui minim minim. Amet ea au./actions/Events commodo commodo in ullamco quis. Voluptate labore officia esse ullamco. Officia ad dolor elit est esse ullamco cupidatat sint. Est proident sint laboris dolore nisi magna irure et aliqua eu exercitation eu et.",
      date: new Date(),
      image: "https://picsum.photos/200",
      location: "PH",
      time: "1pm-5pm",
      fa./actions/Contacts
      eventGuests: [],./actions/Groups
      eventCategory: "Entertain./actions/Relatives
      eventSchedule: [new D./actions/Usersw Date(), 10)],
      eventType: "Event"./actions/UserTypes
    },./reducers
    {
      id: uuid(),
