                                                                ...
                                                                <div className="dmRespCol large-12 medium-12 small-12" id={1301741309} style={{ paddingLeft: 40, paddingRight: 40 }} >
                                                                    ...
                                                                    <div >
                                                                        <div >
                                                                            ...
                                                                            <div style={{ textAlign: 'left', paddingLeft: 12, paddingRight: 12 }}>
                                                                                <ul>
                                                                                    <li style={{ color: 'white', marginTop: 4, marginBottom: 4, fontSize: 18 }}>Track needed Metrics</li>

                                                                                    <li style={{ color: 'white', marginTop: 4, marginBottom: 4, fontSize: 18 }}>User friendly design and experience</li>

                                                                                    <li style={{ color: 'white', marginTop: 4, marginBottom: 4, fontSize: 18 }}>Aggregate data</li>

                                                                                    <li style={{ color: 'white', marginTop: 4, marginBottom: 4, fontSize: 18 }}>Streamline communication</li>

                                                                                    <li style={{ color: 'white', marginTop: 4, marginBottom: 4, fontSize: 18 }}>Automate process and Standardize data collection, across organization</li>

                                                                                    <li style={{ color: 'white', marginTop: 4, marginBottom: 4, fontSize: 18 }}>Reduce effort and time needed to collect, analyze and store data</li>
                                                                                </ul>
                                                                            </div>
                                                                            {/* <div id={1047738323}>
                                                                                <div id={1440166053}>
