        ...
        <div className="form-group">
          <label className="cus-select-container">
            ...
            <input type="radio" 
              ...
              value={"Yes"}
              checked={childGeneralInformation.has_suspended == "Yes" || childGeneralInformation.has_suspended == "1" || (typeof  childGeneralInformation.has_suspended === 'boolean' &&  == true)}
              readOnly={isReadonly}
              disabled={isReadonly}
            />
            <span className="checkmark"></span>
          ...
          <label className="cus-select-container">
            ...
            <input type="radio" 
              ...
              value={"No"}
              checked={childGeneralInformation.has_suspended+"" == "No" || childGeneralInformation.has_suspended == "0" ||  (typeof  childGeneralInformation.has_suspended === 'boolean' &&  == false)}
              readOnly={isReadonly}
              disabled={isReadonly}
            />
            <span className="checkmark"></span>
