...
const EditProfileModal = styled.form`
  ...
  #editProfile .react-datepicker-wrapper {
    margin: 0;
  }
  #editProfile .react-datepicker-wrapper .field-label {
    pointer-events: none;
  }
  #editProfile .react-datepicker__header {
    background-color: #ec6e33;
  }
  #editProfile .react-datepicker__header >div:first-child {
    padding: 10px;
    margin: 0 !important;
  }
  #editProfile .datepicker-btn {
    border: none;
    color: #ffffff;
    box-shadow: none;
...
export default function index({
  ...
  return ReactDOM.createPortal(
    ...
    >
      <div id="editProfile" className="modal-content">
